...
<p align="center">
    <img src="https://raw.githubusercontent.com/Xqhare/talos/refs/heads/master/pics/logo.jpeg" alt="Talos Logo" width="560" height="300"/>
</p>
...
- Input handling
    ...
    - Mouse support
        - Button support (left, middle, right)
        - Drags & Scrolls
- Rendering
...
`Nyx` is a simple dashboard or system explorer for my homelab.
It also pulls in data generated by other tools such as `Lasa` and `Shamash`, also written by me.
...
You can find `Ananke` [here](https://github.com/xqhare/ananke).
...
There are many more examples in the [examples](https://github.com/xqhare/talos/tree/master/examples) directory.
