...
impl Widget for TextBox<'_> {
    ...
    fn render(
            ...
            && let Some(hint_text) = self.hint_text.as_mut()
        {
            ...
            hint_text.render(canvas, area, thoth);
            return;
        }
        ...
        state.text.render(canvas, area, thoth);
    }
}
