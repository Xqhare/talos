...
/// Checks if the Glyph is ASCII and returns the character
///
/// Used for performance
///
/// # Arguments
/// * `g` - The glyph to check
///
/// # Returns
